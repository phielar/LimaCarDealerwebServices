...
public class VehicleBodyTypeServiceTest {
    ...
    private TotalVehicleBodyTypeService service;

    public VehicleBodyTypeServiceTest() {
    }

    @Test
    public void findByMake() throws Exception {
        repo = ctx.getBean(ModelRepository.class);
        service = ctx.getBean(TotalVehicleBodyTypeService.class);
